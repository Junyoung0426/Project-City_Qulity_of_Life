var margin = { top: 10, right: 30, bottom: 30, left: 60 },
    width1 = 560 - margin.left - margin.right,
    height1 = 500 - margin.top - margin.bottom;

var svg2 = d3.select("#mybarchart")
    .append("svg")
    .attr("width", width1 + margin.left + margin.right + 200)
...
function MakeBar(data) {
    ...
    svg2.append("circle").attr("cx", 495).attr("cy", 30).attr("r", 6).style("fill", 'yellow')
    svg2.append("circle").attr("cx", 495).attr("cy", 50).attr("r", 6).style("fill", '#377eb8')
    svg2.append("circle").attr("cx", 495).attr("cy", 70).attr("r", 6).style("fill", '#ff7f00')
    svg2.append("circle").attr("cx", 495).attr("cy", 90).attr("r", 6).style("fill", '#984ea3')
    svg2.append("circle").attr("cx", 495).attr("cy", 110).attr("r", 6).style("fill", '#e41a1c')
    svg2.append("text").attr("x", 525).attr("y", 30).text("0-2: Worst").style("font-size", "14px").attr("alignment-baseline", "middle").style("fill", 'yellow')
    svg2.append("text").attr("x", 525).attr("y", 50).text("2-4: Bad").style("font-size", "14px").attr("alignment-baseline", "middle").style("fill", '#377eb8')
    svg2.append("text").attr("x", 525).attr("y", 70).text("4-6: Normal").style("font-size", "14px").attr("alignment-baseline", "middle").style("fill", '#ff7f00')
    svg2.append("text").attr("x", 525).attr("y", 90).text("6-8: Good").style("font-size", "14px").attr("alignment-baseline", "middle").style("fill", '#984ea3')
    svg2.append("text").attr("x", 525).attr("y", 110).text("8-10: Best").style("font-size", "14px").attr("alignment-baseline", "middle").style("fill", '#e41a1c')
